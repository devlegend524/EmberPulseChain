...
export default function FarmControls({
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center gap-2 justify-between px-2 py-4 main_bg mt-5 rounded-xl">
        <div className="">
          <div className="text-4xl font-bold mb-2">Farms & Staking</div>
        ...
        <div className="flex items-center gap-5 w-full md:w-fit">
          ...
          <div>
            <select
              id="countries"
              className="button_bg border border-[#292524] text-sm rounded-md p-2 bg-transparent outline-0"
          ...
          <div className="flex w-full md:w-fit">
            <input
              value={query}
              className="button_bg p-2 border border-[#292524] rounded-md w-full md:w-fit bg-transparent outline-0"
